...
if __name__ == "__main__":
    ...
    print("Determining best model from models.pickle.", end='\n\n')
    ...
    print("Training best model Ridge Regression for lambda=0 order=4 with parameters alpha=0.02, max_iteration=200000...")
